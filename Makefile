...
CFLAGS	:=	-g -w -O2 -mword-relocations \
...
$(BUILD):
	...
	@mkdir -p 3ds/$(TARGET)
	@mv $(TARGET).3dsx 3ds/$(TARGET)
	@mv $(TARGET).smdh 3ds/$(TARGET)
	@mkdir -p 3ds/$(TARGET)/stuff
	@cp /home/noah/blend/untitled.4d 3ds/$(TARGET)/stuff

#---------------------------------------------------------------------------------
clean:
	@echo clean ...
	@rm -fr $(BUILD) 3ds $(TARGET).3dsx $(OUTPUT).smdh $(TARGET).elf
...
%.shbin.o: %.pica
	...
	@/home/noah/devkitPro/picasso-2.1/picasso -h $(CURH) -o $(CURBIN) $<
	@bin2s $(CURBIN) | $(AS) -o $@
